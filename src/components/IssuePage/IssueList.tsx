...
export default function IssueList() {
  return (
    <>
      <div className='flex container px-4 md:px-6 lg:px-8 mx-auto flex-wrap lg:flex-nowrap  justify-center '>
        ...
        <div className='flex  border-solid border  border-gray-300 rounded-md w-full md:w-6/12 lg:w-full lg:mr-4 my-6 md:my-0 bg-primary-bg-gray '>
          <Button
            text=''
            hasDropDown={false}
            popup={<PopupMenu item='Filters' />}
          />
